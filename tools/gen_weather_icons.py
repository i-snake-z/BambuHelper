...
ICONS = [
    ("clear",         "2600-fe0f",  "Clear sky (WMO 0)"),
    ("mainly_clear",  "1f324-fe0f", "Mainly clear (WMO 1)"),
    ("partly_cloudy", "26c5",       "Partly cloudy (WMO 2)"),
...
def convert_to_rgb565(png_bytes: bytes) -> list[int]:
    """Resize PNG to ICON_W×ICON_H and convert every pixel to RGB565."""
    img = (Image.open(io.BytesIO(png_bytes))
               .convert("RGBA")
               .resize((ICON_W, ICON_H), Image.LANCZOS))
    return [pixel_to_rgb565(r, g, b, a) for r, g, b, a in img.getdata()]
